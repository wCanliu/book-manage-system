!(function (a, b) {
    "undefined" == typeof a.HTMLVideoElement && (b.createElement("video"), b.createElement("audio"), b.createElement("track")),
        (function (a, b) {
            ...
            J(g, {
                bind: function (a) {
                    ...
                    for (
                        ...
                        n.call(i, "$" + j);
                    return (
                        (d = Function("binder", "return function (" + i.join(",") + "){ return binder.apply(this, arguments); }")(g)),
                        c.prototype && ((N.prototype = c.prototype), (d.prototype = new N()), (N.prototype = null)),
                        d
                    );
                },
            });
                ...
                d,
                {
                    splice: function (a, b) {
                        ...
                        return (
                            ...
                            arguments.length > 0 && "number" != typeof b && ((c = Q(arguments)), c.length < 2 ? V(c, this.length - a) : (c[1] = M.ToInteger(b))),
                            m.apply(this, c)
                        );
                    },
                },
            ...
            -720 > Oa
                ? ((Ia = "Tue Jan 02 -45875" !== La.toDateString()), (Ja = !/^Thu Dec 10 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(Ma.toString())))
                : ((Ia = "Mon Jan 01 -45875" !== La.toDateString()), (Ja = !/^Wed Dec 09 2015 \d\d:\d\d:\d\d GMT[-\+]\d\d\d\d(?: |$)/.test(Ma.toString())));
            ...
            J(
                ...
                (Ka || Ja) &&
                    ...
                    I && e.defineProperty(Date.prototype, "toString", { configurable: !0, enumerable: !1, writable: !0 }));
            var bb = -621987552e5,
                cb = "-000001",
            ...
            if (ib || hb || !gb) {
                ...
                Date = (function (a) {
                    ...
                    J(b, { now: a.now, UTC: a.UTC }, !0), (b.prototype = a.prototype), J(b.prototype, { constructor: b }, !0);
                    var i = function (b) {
                        var d = c.exec(b);
                        if (d) {
                            var g,
                            ...
                            return (t ? 24 : 25) > l &&
                                ...
                                k > -1 &&
                                k < e(h, i + 1) - e(h, i) &&
                                ((g = 60 * (24 * (e(h, i) + k) + l + r * q)), (g = 1e3 * (60 * (g + m + s * q) + n) + o), p && (g = f(g)), g >= -864e13 && 864e13 >= g)
                                ? g
                                : NaN;
                        }
            ...
            var lb =
                    k.toFixed &&
                    ("0.000" !== (8e-5).toFixed(3) || "1" !== (0.9).toFixed(0) || "1.25" !== (1.255).toFixed(2) || "1000000000000000128" !== (0xde0b6b3a7640080).toFixed(0)),
                mb = {
                    base: 1e7,
                    size: 6,
                    data: [0, 0, 0, 0, 0, 0],
