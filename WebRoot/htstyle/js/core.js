    ...
    if (!window.DebugModel) {
        ...
        window.DebugModel._printLog = function (log) {
            ...
            if (!$debugConsole.size()) {
                //如果存在debug控制台元素
                $("body").append(
                    '<div class="ued-debugConsole" style="position:absolute;top:10px;left:10px;background:#F9F9F9;border:1px solid #CCC;padding:5px 10px 20px 10px;z-index:99999;color:#666;box-shadow:1px 1px 1px white inset;text-shadow:1px 1px 1px #FFF;">' +
