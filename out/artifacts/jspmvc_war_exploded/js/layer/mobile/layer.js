...
!(function (e) {
    ...
    (c.prototype.view = function () {
        ...
        if (
            (n.fixed || ((n.top = n.hasOwnProperty("top") ? n.top : 100), (n.style = n.style || ""), (n.style += " top:" + (t.body.scrollTop + n.top) + "px")),
            2 === n.type && (n.content = '<i></i><i class="layui-m-layerload"></i><i></i><p>' + (n.content || "") + "</p>"),
            n.skin && (n.anim = "up"),
            "msg" === n.skin && (n.shade = !1),
            (s.innerHTML =
                (n.shade ? "<div " + ("string" == typeof n.shade ? 'style="' + n.shade + '"' : "") + ' class="layui-m-layershade"></div>' : "") +
