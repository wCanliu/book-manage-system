(function () {
    ...
    function r(e, n, i, r) {
        ...
        var c,
            ...
            x = e.contents().detach();
        return (
            i || e.addClass("mathquill-rendered-math"),
            (n.jQ = e.attr(ce, n.id)),
            (n.revert = function () {
                e.empty().unbind(".mathquill").removeClass("mathquill-rendered-math mathquill-editable mathquill-textbox").append(x);
            }),
            (c = n.cursor = re(n)),
            n.renderLatex(x.text()),
            (l = n.textarea = f('<span class="textarea"><textarea></textarea></span>')),
            (m = l.children()),
            ...
            e.bind("mousedown.mathquill", function (n) {
                ...
                function o(t) {
                    (b = a),
                        (c.blink = v),
                        c.selection || (r ? c.show() : l.detach()),
                        e.unbind("mousemove", i),
                        f(t.target.ownerDocument).unbind("mousemove", s).unbind("mouseup", o);
                }
                return (
                    setTimeout(function () {
                        m.focus();
                    ...
                    (c.blink = t),
                    c.seek(f(n.target), n.pageX, n.pageY),
                    (b = d(c.parent, c[u], c[p])),
                    r || e.prepend(l),
                    e.mousemove(i),
                    f(n.target.ownerDocument).mousemove(s).mouseup(o),
                    !1
                );
            }),
            r
                ? ((w = h(m, {
                  ...
                  i && e.addClass("mathquill-textbox"),
                  m
                      .focus(function (t) {
                          c.parent || c.insAtRightEnd(n),
                              c.parent.jQ.addClass("hasCursor"),
                              c.selection ? (c.selection.jQ.removeClass("blur"), setTimeout(n.selectionChanged)) : c.show(),
                              t.stopPropagation();
                      })
                      .blur(function (t) {
                  ...
                  e
                      .bind("focus.mathquill blur.mathquill", function (t) {
                          m.trigger(t);
                      })
                      .blur(),
                  a)
                : ((w = h(m, { container: e })),
                  e
                      .bind("cut paste", !1)
                      .bind("copy", s)
                      .prepend('<span class="selectable">$' + n.latex() + "$</span>"),
                  m.blur(function () {
    ...
    var a,
        ...
        se,
        ae = window.jQuery,
        oe = "mathquill-command-id",
        ce = "mathquill-block-id",
        he = Math.min;
    Math.max,
        (o = [].slice),
        (c = (function (t, e, n) {
        ...
        (h = (function () {
            function e(t) {
                ...
                return (
                    ...
                    t.originalEvent && t.originalEvent.metaKey && s.push("Meta"),
                    t.altKey && s.push("Alt"),
                    t.shiftKey && s.push("Shift"),
                    (e = r || String.fromCharCode(i)),
                    s.length || r ? (s.push(e), s.join("-")) : e
                );
            }
            var n = {
                8: "Backspace",
            ...
            return function (n, i) {
                ...
                return (
                    ...
                    (x = ae(i.container || w)),
                    (k = t),
                    x.bind("keydown keypress input keyup focusout paste", function () {
                        k();
                    }),
                    x.bind({ keydown: h, keypress: l, focusout: p, cut: v, paste: f }),
                    { select: s }
                );
            };
        })()),
        ...
        (g = c(function (t) {
            function e(t, e, i) {
                n("a parent is always present", t),
                    n(
            ...
            (t.init = function (t, e) {
                n("no half-empty fragments", !t == !e),
                    (this.ends = {}),
                    t &&
                        (n("left end node is passed to Fragment", t instanceof m),
                        n("right end node is passed to Fragment", e instanceof m),
                        n("leftEnd and rightEnd have the same parent", t.parent === e.parent),
                        (this.ends[u] = t),
                        (this.ends[p] = e));
            }),
                ...
                (t.disown = function () {
                    ...
                    return !r || i.disowned
                        ...
                        : ((i.disowned = !0),
                          ...
                          e(n, r[u], r),
                          e(n, t, t[p]),
                          r[u] ? (r[u][p] = t[p]) : (n.ends[u] = t[p]),
                          t[p] ? (t[p][u] = r[u]) : (n.ends[p] = r[u]),
                          i);
                }),
                (t.each = function (t) {
                    var e = this,
        ...
        (v = c(m, function (t, e) {
            (t.init = function () {
                ...
                (this.jQize = function (t) {
                    ...
                    return (
                        e
                            ...
                            .each(function () {
                                var t = f(this),
                                    e = t.attr("mathquill-command-id"),
                                    n = t.attr("mathquill-block-id");
                ...
                (t.finalizeInsert = function () {
                    var t = this;
                    t.postOrder("finalizeTree"),
                        t.postOrder("blur"),
                        t.postOrder("respace"),
                        t[p].respace && t[p].respace(),
                        t[u].respace && t[u].respace(),
                        t.postOrder("redraw"),
                        t.bubble("redraw");
                });
        })),
        (w = c(v, function (e, i) {
            (e.init = function (t, e, n) {
                ...
                (e.createLeftOf = function (t) {
                    ...
                    e.createBlocks(),
                        v.jQize(e.html()),
                        n && (n.adopt(e.ends[u], 0, 0), n.jQ.appendTo(e.ends[u].jQ)),
                        t.jQ.before(e.jQ),
                        (t[u] = e.adopt(t.parent, t[u], t[p])),
                        e.finalizeInsert(t),
                        e.placeCursor(t);
                }),
                ...
                (e.respace = t),
                (e.placeCursor = function (t) {
                    t.insAtRightEnd(
                        this.foldChildren(this.ends[u], function (t, e) {
                ...
                (e.html = function () {
                    var t,
                        ...
                        r = this,
                        s = r.blocks,
                        a = " mathquill-command-id=" + r.id,
                        o = r.htmlTemplate.match(/<[^<>]+>|[^<>]+/g);
                    for (n("no unmatched angle brackets", o.join("") === this.htmlTemplate), t = 0, e = o[0]; e; t += 1, e = o[t])
                        if ("/>" === e.slice(-2)) o[t] = e.slice(0, -2) + a + "/>";
                        else if ("<" === e.charAt(0)) {
                            n("not an unmatched top-level close tag", "/" !== e.charAt(1)), (o[t] = e.slice(0, -1) + a + ">"), (i = 1);
                            do (t += 1), (e = o[t]), n("no missing close tags", e), "</" === e.slice(0, 2) ? (i -= 1) : "<" === e.charAt(0) && "/>" !== e.slice(-2) && (i += 1);
                            while (i > 0);
                        }
                ...
                (e.text = function () {
                    ...
                    return t.foldChildren(t.textTemplate[e], function (n, i) {
                        e += 1;
                        var r = i.text();
                        return n && "(" === t.textTemplate[e] && "(" === r[0] && ")" === r.slice(-1)
                            ? n + r.slice(1, -1) + t.textTemplate[e]
                            : n + i.text() + (t.textTemplate[e] || "");
                    });
                });
        })),
        (x = c(w, function (e, n) {
        ...
        (k = c(g, function (t, e) {
            (t.init = function (t, n) {
                e.init.call(this, t, n || t),
                    (this.jQ = this.fold(f(), function (t, e) {
                        return e.jQ.add(t);
                    }));
            }),
                (t.latex = function () {
                ...
                (t.onKey = function (t, e) {
                    ...
                    switch (t) {
                        ...
                        case "Down":
                            ...
                            break;
                        case "Shift-Up":
                            if (this.cursor[u]) for (; this.cursor[u]; ) this.cursor.selectLeft();
                            else this.cursor.selectLeft();
                        case "Shift-Down":
                            if (this.cursor[p]) for (; this.cursor[p]; ) this.cursor.selectRight();
        ...
        (y = c(w, function (t, e) {
            (t.init = function (t) {
                ...
                (t.htmlTemplate = '<span class="mathquill-rendered-math">&0</span>'),
                (t.createBlocks = function () {
                    (this.ends[u] = this.ends[p] = q()),
                        (this.blocks = [this.ends[u]]),
                        (this.ends[u].parent = this),
                        (this.ends[u].cursor = this.cursor),
                        (this.ends[u].write = function (t, e, n) {
                            "$" !== e
                                ? j.prototype.write.call(this, t, e, n)
                                : this.isEmpty()
                                ? (t.insRightOf(this.parent).backspace().show(), Z("\\$", "$").createLeftOf(t))
                                : t[p]
                                ? t[u]
                                    ? j.prototype.write.call(this, t, e, n)
        ...
        (Q = c(j, function (t) {
            (t.renderLatex = function (t) {
                var e,
                    ...
                    g = m.cursor;
                if (
                    (m.jQ.children().slice(1).remove(),
                    (m.ends[u] = m.ends[p] = 0),
                    delete g.selection,
                    g.show().insAtRightEnd(m),
                    (e = l.regex),
                    (n = l.string),
                    (i = l.eof),
                    (r = l.all),
                    ...
                    (o = a.or(e(/^[^$]/)).map(Z)),
                    (c = s.or(o).many()),
                    (h = c.skip(i).or(r.result(!1)).parse(t)))
                ) {
                ...
                (t.onText = q.prototype.onText),
                (t.write = function (t, e, n) {
                    if ((n && n.remove(), "$" === e)) y(t).createLeftOf(t);
                    else {
                        var i;
        ...
        (A = E.style),
        (R = { transform: 1, WebkitTransform: 1, MozTransform: 1, OTransform: 1, msTransform: 1 });
    for (T in R)
        if (T in A) {
            D = T;
            break;
    ...
    D
        ...
        ? ((O = function (t) {
          ...
          (L = function (t, e, n) {
              ...
              (e /= 1 + (n - 1) / 2),
                  t.css("fontSize", n + "em"),
                  t.hasClass("matrixed-container") || t.addClass("matrixed-container").wrapInner('<span class="matrixed"></span>'),
                  (r = t.children().css("filter", "progid:DXImageTransform.Microsoft.Matrix(M11=" + e + ",SizingMethod='auto expand')")),
                  i(),
                  (s = setInterval(i)),
        ...
        (S.mathrm = e(z, "\\mathrm", "span", 'class="roman font"')),
        (S.mathit = e(z, "\\mathit", "i", 'class="font"')),
        (S.mathbf = e(z, "\\mathbf", "b", 'class="font"')),
        (S.mathsf = e(z, "\\mathsf", "span", 'class="sans-serif font"')),
        (S.mathtt = e(z, "\\mathtt", "span", 'class="monospace font"')),
        (S.underline = e(z, "\\underline", "span", 'class="non-leaf underline"')),
        (S.overline = S.bar = e(z, "\\overline", "span", 'class="non-leaf overline"')),
        (B = c(w, function (t, e) {
            (t.init = function (t, n, i) {
                ...
                (t.finalizeTree = function () {
                    ...
                    n("SupSub is only _ and ^", "^" === this.ctrlSeq || "_" === this.ctrlSeq),
                        "_" === this.ctrlSeq ? ((this.down = this.ends[u]), (this.ends[u].up = t)) : ((this.up = this.ends[u]), (this.ends[u].down = t));
                }),
                (t.latex = function () {
                ...
                (t.respace = function () {
                    if (
                        ("\\int " === this[u].ctrlSeq || (this[u] instanceof B && this[u].ctrlSeq != this.ctrlSeq && this[u][u] && "\\int " === this[u][u].ctrlSeq)
                            ? this.limit || ((this.limit = !0), this.jQ.addClass("limit"))
                            : this.limit && ((this.limit = !1), this.jQ.removeClass("limit")),
                        (this.respaced = this[u] instanceof B && this[u].ctrlSeq != this.ctrlSeq && !this[u].respaced),
                        this.respaced)
                    ) {
                        var t = +this.jQ.css("fontSize").slice(0, -2),
                            e = this[u].jQ.outerWidth(),
                            n = this.jQ.outerWidth();
                        this.jQ.css({ left: (this.limit && "_" === this.ctrlSeq ? -0.25 : 0) - e / t + "em", marginRight: 0.1 - he(n, e) / t + "em" });
        ...
        (S.subscript = S._ = e(B, "_", "sub", "_")),
        (S.superscript = S.supscript = S["^"] = e(B, "^", "sup", "**")),
        (I =
            S.frac =
            S.dfrac =
            S.cfrac =
            S.fraction =
                c(w, function (t) {
                    (t.ctrlSeq = "\\frac"),
                        (t.htmlTemplate =
                            '<span class="fraction non-leaf"><span class="numerator">&0</span><span class="denominator">&1</span><span style="display:inline-block;width:0">&nbsp;</span></span>'),
                        (t.textTemplate = ["(", "/", ")"]),
                        (t.finalizeTree = function () {
                ...
                c(I, function (t, e) {
                    t.createLeftOf = function (t) {
                        if (!this.replacedFragment) {
                            ...
                            n instanceof ee && n[p] instanceof B && ((n = n[p]), n[p] instanceof B && n[p].ctrlSeq != n.ctrlSeq && (n = n[p])),
                                n !== t[u] && (this.replaces(k(n[p] || t.parent.ends[u], t[u])), (t[u] = n));
                        }
        ...
        (_ =
            ...
            S["√"] =
                c(w, function (t, e) {
                    (t.ctrlSeq = "\\sqrt"),
                        (t.htmlTemplate = '<span class="non-leaf"><span class="scaled sqrt-prefix">&radic;</span><span class="non-leaf sqrt-stem">&0</span></span>'),
                        (t.textTemplate = ["sqrt(", ")"]),
                        (t.parser = function () {
                            return ie.optBlock
                                .then(function (t) {
                        ...
                        (t.redraw = function () {
                            ...
                            L(t.prev(), 1, t.innerHeight() / +t.css("fontSize").slice(0, -2) - 0.1);
                        });
                })),
        (S.vec = c(w, function (t) {
            (t.ctrlSeq = "\\vec"),
                (t.htmlTemplate = '<span class="non-leaf"><span class="vector-prefix">&rarr;</span><span class="vector-stem">&0</span></span>'),
                (t.textTemplate = ["vec(", ")"]);
        })),
        (W = S.nthroot =
            c(_, function (t) {
                (t.htmlTemplate =
                    '<sup class="nthroot non-leaf">&0</sup><span class="scaled"><span class="sqrt-prefix scaled">&radic;</span><span class="sqrt-stem non-leaf">&1</span></span>'),
                    (t.textTemplate = ["sqrt[", "](", ")"]),
                    (t.latex = function () {
        ...
        (M = c(w, function (t, e) {
            (t.init = function (t, n, i, r) {
                e.init.call(
                    this,
                    "\\left" + i,
                    '<span class="non-leaf"><span class="scaled paren">' +
                        t +
                        "</span>" +
                ...
                (t.redraw = function () {
                    var t = this.ends[u].jQ,
                        e = t.outerHeight() / +t.css("fontSize").slice(0, -2);
                    L(this.bracketjQs, he(1 + 0.2 * (e - 1), 1.2), 1.05 * e);
                });
        })),
        ...
        (S.lbrace = C["{"] = e(M, "{", "}", "\\{", "\\}")),
        (S.langle = S.lang = e(M, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
        (F = c(M, function (t, e) {
            (t.createLeftOf = function (t) {
        ...
        (S.rbrace = C["}"] = e(F, "{", "}", "\\{", "\\}")),
        (S.rangle = S.rang = e(F, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
        (P = function (t, e) {
            t.init = function (t, n) {
        ...
        (U = c(M, P)),
        (S.lparen = C["("] = e(U, "(", ")")),
        (S.lbrack = S.lbracket = C["["] = e(U, "[", "]")),
        (H = c(F, P)),
        (S.rparen = C[")"] = e(H, "(", ")")),
        (S.rbrack = S.rbracket = C["]"] = e(H, "[", "]")),
        (S.lpipe =
            S.rpipe =
            C["|"] =
                c(U, function (t, e) {
        ...
        (K =
            ...
            S.textmd =
                c(w, function (t, e) {
                    (t.ctrlSeq = "\\text"),
                        (t.htmlTemplate = '<span class="text">&0</span>'),
                        ...
                        (t.createLeftOf = function (t) {
                            if ((e.createLeftOf.call(this, (this.cursor = t)), this.replacedText))
                                for (var n = 0; this.replacedText.length > n; n += 1) this.ends[u].write(t, this.replacedText.charAt(n));
                        });
                })),
        (N = c(j, function (t, e) {
            (t.onKey = function (t) {
                ...
                (t.write = function (t, e, n) {
                    ...
                    return (
                        ...
                        "$" !== e
                            ? ("<" === e ? (i = "&lt;") : ">" === e && (i = "&gt;"), Z(e, i).createLeftOf(t))
                            : this.isEmpty()
                            ? (t.insRightOf(this.parent).backspace(), Z("\\$", "$").createLeftOf(t))
                            : t[p]
                            ? t[u]
                                ? ((r = K()),
                                  r.replaces(k(t[p], this.ends[p])),
                                  t.insRightOf(this.parent),
                                  (r.adopt = function () {
                ...
                (t.blur = function () {
                    if ((this.jQ.removeClass("hasCursor"), this.isEmpty())) {
                        ...
                        e.parent === this
                            ...
                            : (e.hide(), t.remove(), e[p] === t ? (e[p] = t[p]) : e[u] === t && (e[u] = t[u]), e.show().parent.bubble("redraw"));
                    }
                    return this;
                }),
                (t.focus = function () {
                    ...
                    return (
                        ...
                        t[p].ctrlSeq === t.ctrlSeq
                            ? ((n = this),
                              ...
                              this.ends[p] ? (this.ends[p][p] = r.ends[u]) : (this.ends[u] = r.ends[u]),
                              (r.ends[u][u] = this.ends[p]),
                              (this.ends[p] = r.ends[p]),
                              r.parent.remove(),
                              i[u] ? i.insRightOf(i[u]) : i.insAtLeftEnd(this),
                              i.parent.bubble("redraw"))
                            : t[u].ctrlSeq === t.ctrlSeq && ((i = t.cursor), i[u] ? t[u].ends[u].focus() : i.insAtRightEnd(t[u].ends[u])),
                        this
                    );
                });
        })),
        (S.em = S.italic = S.italics = S.emph = S.textit = S.textsl = s("\\textit", "i", 'class="text"')),
        (S.strong = S.bold = S.textbf = s("\\textbf", "b", 'class="text"')),
        (S.sf = S.textsf = s("\\textsf", "span", 'class="sans-serif text"')),
        (S.tt = S.texttt = s("\\texttt", "span", 'class="monospace text"')),
        (S.textsc = s("\\textsc", "span", 'style="font-variant:small-caps" class="text"')),
        (S.uppercase = s("\\uppercase", "span", 'style="text-transform:uppercase" class="text"')),
        (S.lowercase = s("\\lowercase", "span", 'style="text-transform:lowercase" class="text"')),
        (C["\\"] = c(w, function (t, e) {
            (t.ctrlSeq = "\\"),
                (t.replaces = function (t) {
                ...
                (t.htmlTemplate = '<span class="latex-command-input non-leaf">\\<span>&0</span></span>'),
                (t.textTemplate = ["\\"]),
                (t.createBlocks = function () {
                    e.createBlocks.call(this),
                        (this.ends[u].focus = function () {
        ...
        (G =
            ...
            S.binomial =
                c(w, function (t) {
                    (t.ctrlSeq = "\\binom"),
                        (t.htmlTemplate =
                            '<span class="paren scaled">(</span><span class="non-leaf"><span class="array non-leaf"><span>&0</span><span>&1</span></span></span><span class="paren scaled">)</span>'),
                        (t.textTemplate = ["choose(", ",", ")"]),
                        (t.redraw = function () {
                            var t = this.jQ.eq(1),
                                e = t.outerHeight() / +t.css("fontSize").slice(0, -2),
                                n = this.jQ.filter(".paren");
                            L(n, he(1 + 0.2 * (e - 1), 1.2), 1.05 * e);
                        });
                })),
        ...
        (S.vector = c(w, function (t, e) {
            (t.ctrlSeq = "\\vector"),
                (t.htmlTemplate = '<span class="array"><span>&0</span></span>'),
                (t.latex = function () {
                    return (
                        "\\begin{matrix}" +
                        this.foldChildren([], function (t, e) {
                ...
                (t.onKey = function (t, e) {
                    var n,
                        i = this.cursor.parent;
                    if (i.parent === this) {
                        if ("Enter" === t)
                            return (
                                (n = j()),
                                (n.parent = this),
                                (n.jQ = f("<span></span>").attr(ce, n.id).insertAfter(i.jQ)),
                                i[p] ? (i[p][u] = n) : (this.ends[p] = n),
                                (n[p] = i[p]),
                                (i[p] = n),
                                (n[u] = i),
                                this.bubble("redraw").cursor.insAtRightEnd(n),
                                e.preventDefault(),
                                !1
                            );
                        if ("Tab" === t && !i[p])
                            return i.isEmpty()
                                ? i[u]
                                    ? (this.cursor.insRightOf(this), delete i[u][p], (this.ends[p] = i[u]), i.jQ.remove(), this.bubble("redraw"), e.preventDefault(), !1)
                                    : a
                                : ((n = j()),
                                  (n.parent = this),
                                  (n.jQ = f("<span></span>").attr(ce, n.id).appendTo(this.jQ)),
                                  (this.ends[p] = n),
                                  (i[p] = n),
                                  (n[u] = i),
                                  this.bubble("redraw").cursor.insAtRightEnd(n),
                        ...
                        if (8 === e.which) {
                            if (i.isEmpty())
                                return (
                                    i[u] ? (this.cursor.insAtRightEnd(i[u]), (i[u][p] = i[p])) : (this.cursor.insLeftOf(this), (this.ends[u] = i[p])),
                                    i[p] ? (i[p][u] = i[u]) : (this.ends[p] = i[u]),
                                    i.jQ.remove(),
                                    this.isEmpty() ? this.cursor.deleteForward() : this.bubble("redraw"),
                                    e.preventDefault(),
                                    !1
                                );
            ...
            (t.init = function () {
                ...
                (t.jQadd = function () {
                    var t,
                        n,
                        i = this;
                    e.jQadd.apply(i, arguments),
                        (t = i.ends[u].disown()),
                        (n = i.jQ.children().detach()),
                        (i.ends[u] = i.ends[p] = q()),
                        (i.blocks = [i.ends[u]]),
                        (i.ends[u].parent = i),
                        r(i.jQ, i.ends[u], !1, !0),
                        (i.cursor = i.ends[u].cursor),
                        t.children().adopt(i.ends[u], 0, 0),
                        n.appendTo(i.ends[u].jQ),
                        i.ends[u].cursor.insAtRightEnd(i.ends[u]);
                }),
                (t.latex = function () {
                    return this.ends[u].latex();
                }),
        ...
        (S.f = e(x, "f", '<var class="florin">&fnof;</var><span style="display:inline-block;width:0">&nbsp;</span>')),
        (X = c(x, function (t, e) {
            (t.init = function (t, n) {
        ...
        (S.phi = e(X, "\\phi ", "&#981;")),
        (S.phiv = S.varphi = e(X, "\\varphi ", "&phi;")),
        (S.epsilon = e(X, "\\epsilon ", "&#1013;")),
        (S.epsiv = S.varepsilon = e(X, "\\varepsilon ", "&epsilon;")),
        (S.piv = S.varpi = e(X, "\\varpi ", "&piv;")),
        (S.sigmaf = S.sigmav = S.varsigma = e(X, "\\varsigma ", "&sigmaf;")),
        (S.thetav = S.vartheta = S.thetasym = e(X, "\\vartheta ", "&thetasym;")),
        (S.upsilon = S.upsi = e(X, "\\upsilon ", "&upsilon;")),
        (S.gammad = S.Gammad = S.digamma = e(X, "\\digamma ", "&#989;")),
        (S.kappav = S.varkappa = e(X, "\\varkappa ", "&#1008;")),
        (S.rhov = S.varrho = e(X, "\\varrho ", "&#1009;")),
        (S.pi = S["π"] = e(Y, "\\pi ", "&pi;")),
        (S.lambda = e(Y, "\\lambda ", "&lambda;")),
        (S.Upsilon = S.Upsi = S.upsih = S.Upsih = e(x, "\\Upsilon ", '<var style="font-family: serif">&upsih;</var>')),
        (S.Gamma =
            S.Delta =
            S.Theta =
            S.Lambda =
        ...
        (S["+"] = e(te, "+", "+")),
        (S["–"] = S["-"] = e(te, "-", "&minus;")),
        (S["±"] = S.pm = S.plusmn = S.plusminus = e(te, "\\pm ", "&plusmn;")),
        (S.mp = S.mnplus = S.minusplus = e(te, "\\mp ", "&#8723;")),
        (C["*"] = S.sdot = S.cdot = e(V, "\\cdot ", "&middot;")),
        (S["="] = e(V, "=", "=")),
        (S["<"] = e(V, "<", "&lt;")),
        (S[">"] = e(V, ">", "&gt;")),
        (S.notin =
        ...
        (S.times = e(V, "\\times ", "&times;", "[x]")),
        (S["÷"] = S.div = S.divide = S.divides = e(V, "\\div ", "&divide;", "[/]")),
        (S["≠"] = S.ne = S.neq = e(V, "\\ne ", "&ne;")),
        (S.ast = S.star = S.loast = S.lowast = e(V, "\\ast ", "&lowast;")),
        (S.therefor = S.therefore = e(V, "\\therefore ", "&there4;")),
        (S.cuz = S.because = e(V, "\\because ", "&#8757;")),
        (S.prop = S.propto = e(V, "\\propto ", "&prop;")),
        (S["≈"] = S.asymp = S.approx = e(V, "\\approx ", "&asymp;")),
        (S.lt = e(V, "<", "&lt;")),
        (S.gt = e(V, ">", "&gt;")),
        (S["≤"] = S.le = S.leq = e(V, "\\le ", "&le;")),
        (S["≥"] = S.ge = S.geq = e(V, "\\ge ", "&ge;")),
        (S.isin = S["in"] = e(V, "\\in ", "&isin;")),
        (S.ni = S.contains = e(V, "\\ni ", "&ni;")),
        (S.notni = S.niton = S.notcontains = S.doesnotcontain = e(V, "\\not\\ni ", "&#8716;")),
        (S.sub = S.subset = e(V, "\\subset ", "&sub;")),
        (S.sup = S.supset = S.superset = e(V, "\\supset ", "&sup;")),
        (S.nsub = S.notsub = S.nsubset = S.notsubset = e(V, "\\not\\subset ", "&#8836;")),
        (S.nsup = S.notsup = S.nsupset = S.notsupset = S.nsuperset = S.notsuperset = e(V, "\\not\\supset ", "&#8837;")),
        (S.sube = S.subeq = S.subsete = S.subseteq = e(V, "\\subseteq ", "&sube;")),
        (S.supe = S.supeq = S.supsete = S.supseteq = S.supersete = S.superseteq = e(V, "\\supseteq ", "&supe;")),
        (S.nsube = S.nsubeq = S.notsube = S.notsubeq = S.nsubsete = S.nsubseteq = S.notsubsete = S.notsubseteq = e(V, "\\not\\subseteq ", "&#8840;")),
        (S.nsupe =
            S.nsupeq =
            S.notsupe =
            S.notsupeq =
        ...
        (S["∑"] = S.sum = S.summation = e(ee, "\\sum ", "&sum;")),
        (S["∏"] = S.prod = S.product = e(ee, "\\prod ", "&prod;")),
        (S.coprod = S.coproduct = e(ee, "\\coprod ", "&#8720;")),
        (S["∫"] = S["int"] = S.integral = e(ee, "\\int ", "&int;")),
        (S.N = S.naturals = S.Naturals = e(Z, "\\mathbb{N}", "&#8469;")),
        (S.P = S.primes = S.Primes = S.projective = S.Projective = S.probability = S.Probability = e(Z, "\\mathbb{P}", "&#8473;")),
        (S.Z = S.integers = S.Integers = e(Z, "\\mathbb{Z}", "&#8484;")),
        (S.Q = S.rationals = S.Rationals = e(Z, "\\mathbb{Q}", "&#8474;")),
        (S.R = S.reals = S.Reals = e(Z, "\\mathbb{R}", "&#8477;")),
        (S.C = S.complex = S.Complex = S.complexes = S.Complexes = S.complexplane = S.Complexplane = S.ComplexPlane = e(Z, "\\mathbb{C}", "&#8450;")),
        (S.H = S.Hamiltonian = S.quaternions = S.Quaternions = e(Z, "\\mathbb{H}", "&#8461;")),
        (S.quad = S.emsp = e(Z, "\\quad ", "    ")),
        (S.qquad = e(Z, "\\qquad ", "        ")),
        (S.diamond = e(Z, "\\diamond ", "&#9671;")),
        (S.bigtriangleup = e(Z, "\\bigtriangleup ", "&#9651;")),
        (S.ominus = e(Z, "\\ominus ", "&#8854;")),
        (S.uplus = e(Z, "\\uplus ", "&#8846;")),
        (S.bigtriangledown = e(Z, "\\bigtriangledown ", "&#9661;")),
        (S.sqcap = e(Z, "\\sqcap ", "&#8851;")),
        (S.triangleleft = e(Z, "\\triangleleft ", "&#8882;")),
        (S.sqcup = e(Z, "\\sqcup ", "&#8852;")),
        (S.triangleright = e(Z, "\\triangleright ", "&#8883;")),
        (S.odot = e(Z, "\\odot ", "&#8857;")),
        (S.bigcirc = e(Z, "\\bigcirc ", "&#9711;")),
        (S.dagger = e(Z, "\\dagger ", "&#0134;")),
        (S.ddagger = e(Z, "\\ddagger ", "&#135;")),
        (S.wr = e(Z, "\\wr ", "&#8768;")),
        (S.amalg = e(Z, "\\amalg ", "&#8720;")),
        (S.models = e(Z, "\\models ", "&#8872;")),
        (S.prec = e(Z, "\\prec ", "&#8826;")),
        ...
        (S.ll = e(Z, "\\ll ", "&#8810;")),
        (S.gg = e(Z, "\\gg ", "&#8811;")),
        (S.parallel = e(Z, "\\parallel ", "&#8741;")),
        (S.bowtie = e(Z, "\\bowtie ", "&#8904;")),
        (S.sqsubset = e(Z, "\\sqsubset ", "&#8847;")),
        (S.sqsupset = e(Z, "\\sqsupset ", "&#8848;")),
        (S.smile = e(Z, "\\smile ", "&#8995;")),
        (S.sqsubseteq = e(Z, "\\sqsubseteq ", "&#8849;")),
        (S.sqsupseteq = e(Z, "\\sqsupseteq ", "&#8850;")),
        (S.doteq = e(Z, "\\doteq ", "&#8784;")),
        (S.frown = e(Z, "\\frown ", "&#8994;")),
        (S.vdash = e(Z, "\\vdash ", "&#8870;")),
        (S.dashv = e(Z, "\\dashv ", "&#8867;")),
        (S.longleftarrow = e(Z, "\\longleftarrow ", "&#8592;")),
        (S.longrightarrow = e(Z, "\\longrightarrow ", "&#8594;")),
        (S.Longleftarrow = e(Z, "\\Longleftarrow ", "&#8656;")),
        (S.Longrightarrow = e(Z, "\\Longrightarrow ", "&#8658;")),
        (S.longleftrightarrow = e(Z, "\\longleftrightarrow ", "&#8596;")),
        (S.updownarrow = e(Z, "\\updownarrow ", "&#8597;")),
        (S.Longleftrightarrow = e(Z, "\\Longleftrightarrow ", "&#8660;")),
        (S.Updownarrow = e(Z, "\\Updownarrow ", "&#8661;")),
        (S.mapsto = e(Z, "\\mapsto ", "&#8614;")),
        (S.nearrow = e(Z, "\\nearrow ", "&#8599;")),
        (S.hookleftarrow = e(Z, "\\hookleftarrow ", "&#8617;")),
        (S.hookrightarrow = e(Z, "\\hookrightarrow ", "&#8618;")),
        (S.searrow = e(Z, "\\searrow ", "&#8600;")),
        (S.leftharpoonup = e(Z, "\\leftharpoonup ", "&#8636;")),
        (S.rightharpoonup = e(Z, "\\rightharpoonup ", "&#8640;")),
        (S.swarrow = e(Z, "\\swarrow ", "&#8601;")),
        (S.leftharpoondown = e(Z, "\\leftharpoondown ", "&#8637;")),
        (S.rightharpoondown = e(Z, "\\rightharpoondown ", "&#8641;")),
        (S.nwarrow = e(Z, "\\nwarrow ", "&#8598;")),
        (S.ldots = e(Z, "\\ldots ", "&#8230;")),
        (S.cdots = e(Z, "\\cdots ", "&#8943;")),
        (S.vdots = e(Z, "\\vdots ", "&#8942;")),
        ...
        (S.wp = e(Z, "\\wp ", "&#8472;")),
        (S.bot = e(Z, "\\bot ", "&#8869;")),
        (S.clubsuit = e(Z, "\\clubsuit ", "&#9827;")),
        (S.diamondsuit = e(Z, "\\diamondsuit ", "&#9826;")),
        (S.heartsuit = e(Z, "\\heartsuit ", "&#9825;")),
        (S.spadesuit = e(Z, "\\spadesuit ", "&#9824;")),
        (S.oint = e(Z, "\\oint ", "&#8750;")),
        (S.bigcap = e(Z, "\\bigcap ", "&#8745;")),
        (S.bigcup = e(Z, "\\bigcup ", "&#8746;")),
        (S.bigsqcup = e(Z, "\\bigsqcup ", "&#8852;")),
        (S.bigvee = e(Z, "\\bigvee ", "&#8744;")),
        (S.bigwedge = e(Z, "\\bigwedge ", "&#8743;")),
        (S.bigodot = e(Z, "\\bigodot ", "&#8857;")),
        (S.bigotimes = e(Z, "\\bigotimes ", "&#8855;")),
        (S.bigoplus = e(Z, "\\bigoplus ", "&#8853;")),
        (S.biguplus = e(Z, "\\biguplus ", "&#8846;")),
        (S.lfloor = e(Z, "\\lfloor ", "&#8970;")),
        (S.rfloor = e(Z, "\\rfloor ", "&#8971;")),
        (S.lceil = e(Z, "\\lceil ", "&#8968;")),
        (S.rceil = e(Z, "\\rceil ", "&#8969;")),
        (S.slash = e(Z, "\\slash ", "&#47;")),
        (S.opencurlybrace = e(Z, "\\opencurlybrace ", "&#123;")),
        (S.closecurlybrace = e(Z, "\\closecurlybrace ", "&#125;")),
        (S.caret = e(Z, "\\caret ", "^")),
        (S.underscore = e(Z, "\\underscore ", "_")),
        (S.backslash = e(Z, "\\backslash ", "\\")),
        (S.vert = e(Z, "|")),
        (S.perp = S.perpendicular = e(Z, "\\perp ", "&perp;")),
        (S.nabla = S.del = e(Z, "\\nabla ", "&nabla;")),
        (S.hbar = e(Z, "\\hbar ", "&#8463;")),
        (S.AA = S.Angstrom = S.angstrom = e(Z, "\\text\\AA ", "&#8491;")),
        (S.ring = S.circ = S.circle = e(Z, "\\circ ", "&#8728;")),
        (S.bull = S.bullet = e(Z, "\\bullet ", "&bull;")),
        (S.setminus = S.smallsetminus = e(Z, "\\setminus ", "&#8726;")),
        (S.not = S["¬"] = S.neg = e(Z, "\\neg ", "&not;")),
        (S["…"] = S.dots = S.ellip = S.hellip = S.ellipsis = S.hellipsis = e(Z, "\\dots ", "&hellip;")),
        (S.converges = S.darr = S.dnarr = S.dnarrow = S.downarrow = e(Z, "\\downarrow ", "&darr;")),
        (S.dArr = S.dnArr = S.dnArrow = S.Downarrow = e(Z, "\\Downarrow ", "&dArr;")),
        (S.diverges = S.uarr = S.uparrow = e(Z, "\\uparrow ", "&uarr;")),
        (S.uArr = S.Uparrow = e(Z, "\\Uparrow ", "&uArr;")),
        (S.to = e(V, "\\to ", "&rarr;")),
        (S.rarr = S.rightarrow = e(Z, "\\rightarrow ", "&rarr;")),
        (S.implies = e(V, "\\Rightarrow ", "&rArr;")),
        (S.rArr = S.Rightarrow = e(Z, "\\Rightarrow ", "&rArr;")),
        (S.gets = e(V, "\\gets ", "&larr;")),
        (S.larr = S.leftarrow = e(Z, "\\leftarrow ", "&larr;")),
        (S.impliedby = e(V, "\\Leftarrow ", "&lArr;")),
        (S.lArr = S.Leftarrow = e(Z, "\\Leftarrow ", "&lArr;")),
        (S.harr = S.lrarr = S.leftrightarrow = e(Z, "\\leftrightarrow ", "&harr;")),
        (S.iff = e(V, "\\Leftrightarrow ", "&hArr;")),
        (S.hArr = S.lrArr = S.Leftrightarrow = e(Z, "\\Leftrightarrow ", "&hArr;")),
        (S.Re = S.Real = S.real = e(Z, "\\Re ", "&real;")),
        (S.Im = S.imag = S.image = S.imagin = S.imaginary = S.Imaginary = e(Z, "\\Im ", "&image;")),
        (S.part = S.partial = e(Z, "\\partial ", "&part;")),
        (S.inf = S.infin = S.infty = S.infinity = e(Z, "\\infty ", "&infin;")),
        (S.alef = S.alefsym = S.aleph = S.alephsym = e(Z, "\\aleph ", "&alefsym;")),
        (S.xist = S.xists = S.exist = S.exists = e(Z, "\\exists ", "&exist;")),
        (S.and = S.land = S.wedge = e(Z, "\\wedge ", "&and;")),
        (S.or = S.lor = S.vee = e(Z, "\\vee ", "&or;")),
        (S.o = S.O = S.empty = S.emptyset = S.oslash = S.Oslash = S.nothing = S.varnothing = e(V, "\\varnothing ", "&empty;")),
        (S.cup = S.union = e(V, "\\cup ", "&cup;")),
        (S.cap = S.intersect = S.intersection = e(V, "\\cap ", "&cap;")),
        (S.deg = S.degree = e(Z, "^\\circ ", "&deg;")),
        (S.ang = S.angle = e(Z, "\\angle ", "&ang;")),
        (ne = c(x, function (t, e) {
            (t.init = function (t) {
        ...
        (S.ln = S.lg = S.log = S.span = S.proj = S.det = S.dim = S.min = S.max = S.mod = S.lcm = S.gcd = S.gcf = S.hcf = S.lim = ne),
        (function () {
            var t,
                e = ["sin", "cos", "tan", "sec", "cosec", "csc", "cotan", "cot"];
        ...
        (ie = (function () {
            ...
            var n = l.string,
                ...
                m = n("{")
                    ...
                    .skip(n("}")),
                g = a.then(m.or(d.map(t))),
                b = g.many().map(e).skip(a),
                v = n("[")
                    .then(
                        g
                            .then(function (t) {
        ...
        (re = c(d, function (t) {
            function e(t, e) {
                var i, r, s, a;
                if (t[p][e]) t.insAtLeftEnd(t[p][e]);
                else if (t[u][e]) t.insAtRightEnd(t[u][e]);
                else {
                    i = t.parent;
                    do {
                        if (((r = i[e]), r && ("function" == typeof r && (r = i[e](t)), r === !1 || r instanceof j))) {
                            (t.upDownCache[i.id] = d(t.parent, t[u], t[p])),
                                r instanceof j &&
                                    ((s = t.upDownCache[r.id]),
                                    s ? (s[p] ? t.insLeftOf(s[p]) : t.insAtRightEnd(s.parent)) : ((a = n(t).left), t.insAtRightEnd(r), t.seekHoriz(a, r)));
                            break;
                        }
                        i = i.parent.parent;
                    } while (i);
            ...
            (t.init = function (t) {
                ...
                (t.show = function () {
                    return (
                        ...
                        "intervalId" in this
                            ...
                            : (this[p]
                                  ? this.selection && this.selection.ends[u][u] === this[u]
                                      ? this.jQ.insertBefore(this.selection.jQ)
                                      : this.jQ.insertBefore(this[p].jQ.first())
                ...
                (t.moveDirWithin = function (t, e) {
                    if ((i(t), this[t])) this[t].ends[-t] ? this.insAtDirEnd(-t, this[t].ends[-t]) : this.hopDir(t);
                    else {
                ...
                (t.seek = function (t, e) {
                    ...
                    var n,
                        i,
                        s = this.clearSelection().show();
                    return t.hasClass("empty")
                        ? (s.insAtLeftEnd(v[t.attr(ce)]), s)
                        : ((n = v[t.attr(oe)]),
                          n instanceof x
                              ? (t.outerWidth() > 2 * (e - t.offset().left) ? s.insLeftOf(n) : s.insRightOf(n), s)
                              : (n || ((i = v[t.attr(ce)]), i || ((t = t.parent()), (n = v[t.attr(oe)]), n || ((i = v[t.attr(ce)]), i || (i = s.root)))),
                                n ? s.insRightOf(n) : s.insAtRightEnd(i),
                                s.seekHoriz(e, s.root)));
                }),
                (t.seekHoriz = function (t, e) {
                    var i,
                        r = this,
                        s = n(r).left - t;
                    do r.moveLeftWithin(e), (i = s), (s = n(r).left - t);
                    while (s > 0 && (r[u] || r.parent !== e));
                ...
                (t.writeLatex = function (t) {
                    ...
                    return (
                        r(s),
                        s.show().deleteSelection(),
                        (e = l.all),
                        (n = l.eof),
                        (i = ie.skip(n).or(e.result(!1)).parse(t)),
                        i &&
                            (i.children().adopt(s.parent, s[u], s[p]),
                            v.jQize(i.join("html")).insertBefore(s.jQ),
                            (s[u] = i.ends[p]),
                            i.finalizeInsert(),
                            s.parent.bubble("redraw")),
                        this.hide()
                    );
                }),
                (t.write = function (t) {
                ...
                (t.insertCmd = function (t, e) {
                    ...
                    return (
                        n
                            ? ((n = n(t)), e && n.replaces(e), n.createLeftOf(this))
                            : ((n = K()),
                              n.replaces(t),
                              (n.ends[u].focus = function () {
                ...
                (t.deleteDir = function (t) {
                    if ((i(t), r(this), this.show(), this.deleteSelection()));
                    else if (this[t]) this[t].isEmpty() ? (this[t] = this[t].remove()[t]) : this.selectDir(t);
                ...
                (t.selectFrom = function (t) {
                    var e,
                        ...
                        c = t;
                    t: for (;;) {
                        for (e = this; e !== o.parent.parent; e = e.parent.parent)
                            if (e.parent === c.parent) {
                                (i = e), (r = c);
                                break t;
                            }
                        for (n = t; n !== c.parent.parent; n = n.parent.parent)
                    ...
                    (this.hide().selection = se(i[u][p] || i.parent.ends[u], r[p][u] || r.parent.ends[p])),
                        this.insRightOf(r[p][u] || r.parent.ends[p]),
                        this.root.selectionChanged();
                }),
                (t.selectDir = function (t) {
                    if ((i(t), r(this), this.selection))
                        if (this.selection.ends[t] === this[-t])
                            this[t] ? this.hopDir(t).selection.extendDir(t) : this.parent !== this.root && this.insDirOf(t, this.parent.parent).selection.levelUp();
                        else {
                ...
                (t.deleteSelection = function () {
                    return this.selection
                        ? ((this[u] = this.selection.ends[u][u]),
        ...
        (se = c(k, function (t, e) {
            (t.init = function () {
                ...
                (t.levelUp = function () {
                    var t = this,
                        e = (t.ends[u] = t.ends[p] = t.ends[p].parent.parent);
        ...
        ae(function () {
            ae(".mathquill-editable:not(.mathquill-rendered-math)").mathquill("editable"),
                ae(".mathquill-textbox:not(.mathquill-rendered-math)").mathquill("textbox"),
                ae(".mathquill-embedded-latex").mathquill();
        });
})();
