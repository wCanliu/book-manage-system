        ...
        <div class="panel-body">
            <div class="form-search pa10 bg-warning">
                <form class="form-inline" action="?" size="small" id="formSearch">
                    ...
                    分类：
                    <select class="form-control class_fenlei12" data-value="${param.fenlei}" id="fenlei" name="fenlei">
                    ...
                    <script>
                        $(".class_fenlei12").val($(".class_fenlei12").attr("data-value"));
                    </script>
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${lists}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>${map.mingcheng}</td>
                                <td><ssm:sql var="mapfenlei13" type="find">SELECT fenleiming,id FROM fenlei where id='${map.fenlei}'</ssm:sql>${mapfenlei13.fenleiming}</td>
                                <td>${map.zuozhe}</td>
                                <td>${map.yonghu}</td>
