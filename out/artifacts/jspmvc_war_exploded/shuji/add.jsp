...
<div>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="shuji.do?ac=insert" method="post" name="form1" id="form1">
                <!-- form 标签开始 -->
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="输入作者" style="width: 150px" id="zuozhe" name="zuozhe" value="" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" placeholder="输入出版社" style="width: 250px" id="chubanshe" name="chubanshe" value="" />
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <input
                                ...
                                remote="common.do?ac=checkno&checktype=insert&table=shuji&col=isbn"
